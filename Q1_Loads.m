...
theta_0 = deg2rad(8.2); % Collective Pitch
theta_1c = deg2rad(3.3);% 
theta_1s = deg2rad(-11.2);% Cyclic Pitch
...
Thrust = T_Thrust;
% Rotor Drag
T_Rotor_Drag = (Sum_F_x);
Rotor_Drag = T_Rotor_Drag;
% Rotor Side Force
T_Rotor_SF = (Sum_F_y);
Rotor_SF = T_Rotor_SF;
...
% Rotor Torque Mz
T_Rotor_Torque = (Sum_M_z) ;
Rotor_Torque = T_Rotor_Torque;
% Rotor Roll Moment Mx
T_Rotor_Roll = (Sum_M_x) ;
Rotor_Roll = T_Rotor_Roll;
% Rotor Pitch Moment My
T_Rotor_Pitch = (Sum_M_y) ;
Rotor_Pitch = T_Rotor_Pitch;

%output = [ T_Rotor_Drag, T_Rotor_SF, T_Thrust, T_Rotor_Roll, T_Rotor_Pitch, T_Rotor_Torque ] ;
